;*******************************************************************************
;* SIMD-optimized IDCT functions for VVC decoding
...
; void ff_vvc_inv_dct2_dct2_HxW_dc_{8,10}_<opt>(int16_t *coeffs)
; %1 = HxW
; %2 = number of loops
; %3 = bitdepth
%macro IDCT_DC 3
cglobal vvc_inv_dct2_dct2_%1x%1_dc_%3, 1, 2, 1, coeff, tmp
...
cglobal vvc_inv_dct2_dct2_%1x%1_dc_%2, 1, 2, 1, coeff, tmp
    movsx             tmpd, word [coeffq]
    add               tmpd, (1 << (14 - %2)) + 1
    sar               tmpd, (15 - %2)
    movd                m0, tmpd
...
cglobal vvc_inv_dct2_dct2_8x8_%1, 2, 2, 8, dst, coeffs
    ...
    call vvc_inv_dct2_dct2_transpose_8x8_ %+ cpuname

    DEFINE_BIAS %1
    TR_8x4 0, shift, 32, 1, 16, 8, 1
    TR_8x4 8, shift, 32, 1, 16, 8, 1

    TAIL_CALL vvc_inv_dct2_dct2_transpose_8x8_ %+ cpuname, 1
%endmacro
